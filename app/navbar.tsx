          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 justify-between">
              ...
              <div className="-mr-2 flex items-center sm:hidden">
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 dark:hover:bg-gray-900 p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2">
            ...
            <div className="space-y-1 pt-2 pb-3">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    pathname === item.href
                      ? 'bg-slate-50 border-slate-500 text-slate-700 dark:bg-gray-950 dark:text-slate-100'
                      : 'border-transparent text-gray-600 dark:text-slate-200 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800',
